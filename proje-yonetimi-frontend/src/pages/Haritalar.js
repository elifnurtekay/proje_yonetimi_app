      ...
      <div className="processes-map-wrapper">
        ...
        {processesWithCoords.length > 0 ? (
          ...
          <div className="processes-empty-map">
            {loading ? "Harita yükleniyor..." : "Haritada gösterilecek konumu olan bir süreç bulunamadı."}
            <div style={{ marginTop: 6, color: "#6b7280" }}>
                Yeni süreç eklerken şehir, ilçe, mahalle, sokak ve cadde bilgilerini doldurduğunuzda,
                sistem adresi otomatik olarak konuma çevirir ve burada gösterir.
            </div>
           </div>
        )}
      </div>
