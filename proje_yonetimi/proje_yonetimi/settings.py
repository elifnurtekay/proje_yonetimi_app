"""
Django settings for proje_yonetimi project.
...
SECRET_KEY = 'django-insecure-sgp)ezdq9hmrp)v^q=)a@0ly4&^psgc(3#^f&_09!+$qnw#30g'
...
WSGI_APPLICATION = 'proje_yonetimi.wsgi.application'
...
SIMPLE_JWT = { "AUTH_HEADER_TYPES": ("Bearer",), "ACCESS_TOKEN_LIFETIME": timedelta(minutes=60) }
